...
Author.loadAll = function () {
  var key="", keys=[], authors={}, persons={}, authorRow={}, i=0;
  ...
  for (i=0; i < keys.length; i++) {
    ...
    authorRow.name = persons[key].name;
    Author.instances[key] = Author.convertRow2Obj( authorRow);
  }
};
/**
...
Author.saveAll = function () {
  ...
  for (i=0; i < keys.length; i++) {
    ...
    authorRow = author.convertObj2Row();
